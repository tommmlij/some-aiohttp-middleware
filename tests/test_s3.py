...
from aiohttp.web import View, HTTPOk, Request, Response
from aiohttp_middlewares import error_middleware, error_context
from pydantic import BaseModel

from some_aiohttp_middleware import S3Config, S3
...
class Config(BaseModel):
    s3: list[S3Config] = [
        S3Config("1",
                 region="eu-west-1",
                 bucket=os.environ["SOME_BUCKET"]),
        S3Config("2",
                 region="eu-west-1",
                 bucket=os.environ["SOME_OTHER_BUCKET"]),
    ]
